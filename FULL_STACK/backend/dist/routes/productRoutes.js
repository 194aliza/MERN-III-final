...
import { getProducts, getProductById, createProduct, updateProduct, deleteProduct, getProductStats, // ✅ FIXED NAME
...
//  Protected routes
router.post("/:id/image", protect, admin, upload.single("image"), asyncHandler(uploadProductImage));
